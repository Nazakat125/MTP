...
class DetailLaon extends StatefulWidget {
  const DetailLaon({super.key});

  @override
  State<DetailLaon> createState() => _DetailLaonState();
}

class _DetailLaonState extends State<DetailLaon> {
  @override
