...
class SendLoan extends StatefulWidget {
  const SendLoan({super.key});

  @override
  State<SendLoan> createState() => _SendLoanState();
}

class _SendLoanState extends State<SendLoan> {
            ...
            children: [
              ...
              Positioned(
                bottom: 0,
                  left: 0,
                  right: 0,
                  child: CustomButton(onPressed: () {}, text: AppText.Confirm))
            ],
          ),
        ),
      ),
